...
# multi threading to omit Windows10 errors:
...
import requests
# for multi-threading to omit 500 Google Sign-in errors
# (Windows10, various browsers etc.)
import threading
...
# for multi-threading to omit browser errors (Windows10, various browsers etc.)
engine = create_engine(
    'sqlite:///item_catalog.db', connect_args={'check_same_thread': False},
    # and to omit Google Signin 500 error (?is below necessary?):
